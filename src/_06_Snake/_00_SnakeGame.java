...
public class _00_SnakeGame implements ActionListener, KeyListener {
	...
	private void setFoodLocation() {
		...
		Location l = new Location(new Random().nextInt(WIDTH), new Random().nextInt(HEIGHT));
		//2. set the foodLocation variable equal to the Location object you just created.
		if(snake.isLocationOnSnake(l) != true) {foodLocation = l;}
		else {setFoodLocation();}
	...
	private void gameOver() {
		...
		int select = JOptionPane.showConfirmDialog(null, "Your snake is dead. Play Again?");
